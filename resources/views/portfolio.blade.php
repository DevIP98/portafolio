                                        ...
                                        <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                                            <div class="flex items-center justify-between w-full md:w-auto">
                                                <a href="#">
                                                    ...
                                                    <img alt="Workflow" class="h-10 w-auto sm:h-12"
                                                        src="{{ asset('/hero/coding.png') }}">
                                                </a>
                                ...
                                <div x-show="open" x-transition:enter="duration-150 ease-out"
                                    ...
                                    <div
                                        ...
                                        <div class="px-5 pt-4 flex items-center justify-between">
                                            <div>
                                                <img class="h-8 w-auto" src="{{ asset('/hero/coding.png') }}"
                                                    alt="Logo">
                                            </div>
                                            <div class="-mr-2">
                                                <button type="button"
                                        ...
                                        <div class="px-2 pt-2 pb-3 space-y-1">
                                            <a href="#"
                                                class="font-medium block px-3 py-2 rounded-md text-base text-gray-700 hover:text-gray-900 hover:bg-gray-50">Link
                                                1</a>
                                            <a href="#"
                                                class="font-medium block px-3 py-2 rounded-md text-base text-gray-700 hover:text-gray-900 hover:bg-gray-50">Link
                                                2</a>
